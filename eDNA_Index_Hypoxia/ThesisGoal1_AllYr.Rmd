...
# Plot + save
    ...
    ggsave(filename = paste(species, sep = "_", "eDNA_DO_Temp_ScatterSize_23.png"), 
           path = here("eDNA_Index_Hypoxia", "Plots", "DO_Temp_Scatter_23"), 
...
# Plot + save
    ...
    ggsave(filename = paste(species, sep = "_", "eDNA_DO_Temp_ScatterSize_AllBackground_23.png"), 
           path = here("eDNA_Index_Hypoxia", "Plots", "DO_Temp_Scatter_23"), 
           width = 2500, height = 2000, units = "px")
}
```
...
# Plot + save
    ...
    ggsave(filename = paste(species, sep = "_", "eDNA_DO_Scatter_23.png"), 
           path = here("eDNA_Index_Hypoxia", "Plots", "eDNA_DO_Scatter_23"), 
           width = 2500, height = 2000, units = "px")
}
```
...
# Plot + save
    ...
    ggsave(filename = paste(species, sep = "_", "eDNA_Env_Density_23.png"), 
           path = here("eDNA_Index_Hypoxia", "Plots", "eDNA_Env_Density_23"), 
           width = 2500, height = 2000, units = "px")
}
```
