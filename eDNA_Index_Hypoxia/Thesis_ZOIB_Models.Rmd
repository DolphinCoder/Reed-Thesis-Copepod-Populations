...
for (i in 1:length(dfsplit)) { # For each species: 
    ...
    data %>%
      ...
      labs(title = title, caption = "Conditional Means?") +
      theme_bw()
    
    ggsave(filename = paste(species, sep = "_", "eDNA_DO_ZOIB_Means.png"), 
           path = here("eDNA_Index_Hypoxia", "Plots", "ZOIB_Means"), 
    ...
    ggsave(filename = paste(species, sep = "_", "eDNA_DO_ZOIB_Posterior.png"), 
           path = here("eDNA_Index_Hypoxia", "Plots", "ZOIB_Posterior_Predictions"), 
           width = 2500, height = 2000, units = "px")
