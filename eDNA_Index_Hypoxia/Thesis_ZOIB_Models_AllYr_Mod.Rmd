...
for (i in 1:length(dfsplit)) { # For each species: 
    ...
    dataF <- data %>% filter(DO < 6) # no outlier
    ...
    dataF %>%
      ...
      labs(title = title, caption = "Conditional Means, LiveOcean Model", x = "eDNA index") +
      theme_bw() +
    ...
    ggsave(filename = paste(species, sep = "_", "ZOIB_Means_Mod_noOut.png"), 
           path = here("eDNA_Index_Hypoxia", "Plots", "ZOIB_Means_AllYr_Mod_noOut_pub"), 
    ...
    ggsave(filename = paste(species, sep = "_", "eDNA_DO_ZOIB_Posterior_AllYr_Mod_noOut.png"), 
           path = here("eDNA_Index_Hypoxia", "Plots", "ZOIB_Posterior_Predictions_AllYr_Mod_noOut"), 
           width = 2500, height = 2000, units = "px")
