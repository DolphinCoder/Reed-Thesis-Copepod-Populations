...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption[Map of OCNMS]{\footnotesize{The coast of Washington State with the border of Olympic National Marine Sanctuary (OCNMS) in red. Image from \autocite{OlympicCoastNationalb}.}} %the special ToC caption is in square brackets. The \footnotesize makes the figure caption smaller
	\end{center}
	\label{OCNMSMap}
\end{figure} 
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption[Life cycle of copepods]{\footnotesize{Simplified \textit{Paracartia grani} life cycle, not to scale. N: nauplius, C: copepodite. Copyright C. Traboni. \autocite{Traboni2022}}} %the special ToC caption is in square brackets. The \footnotesize makes the figure caption smaller
	\end{center}
	\label{LifeCycle}
\end{figure} 
